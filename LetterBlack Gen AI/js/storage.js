...
(function() {
    ...
    class BrowserChatStore {
        ...
        async clearAllChats() {
            try {
                ...
                this.logger.error('Failed to clear chats:', error);
                return false;
            }
        }
    ...
    class ChatStorageManager {
        ...
        async initialize() {
            try {
                ...
                this.logger.debug('✅ ChatStorageManager initialized');
                return true;
            } catch (error) {
                this.logger.error('❌ Failed to initialize ChatStorageManager:', error);
                return false;
            }
        }
        ...
        async saveCurrentChat() {
            try {
                ...
                this.logger.error('Failed to save current chat:', error);
                return false;
            }
        }
        ...
        async switchChat(chatId) {
            try {
                ...
                this.logger.error('Failed to switch chat:', error);
                return false;
            }
        }
        ...
        async clearCurrentChat() {
            try {
                ...
                this.logger.error('Failed to clear current chat:', error);
                return false;
            }
        }
        ...
        async cleanup() {
            try {
                ...
                this.logger.debug('✅ ChatStorageManager cleanup completed');
            } catch (error) {
                this.logger.error('❌ ChatStorageManager cleanup failed:', error);
            }
        }
    }
    ...
    this.logger.debug('✅ Storage module loaded');
