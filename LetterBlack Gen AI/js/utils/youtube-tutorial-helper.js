...
class YouTubeTutorialHelper {
    constructor() {
        ...
        this.logger.debug('🎬 YouTube Tutorial Helper initialized');
    }
    ...
    async processYouTubeLink(userMessage) {
        ...
        try {
            ...
            this.logger.error('Error processing YouTube tutorial:', error);
    ...
    clearCache() {
        ...
        this.currentTutorial = null;
        this.logger.debug('🗑️ Tutorial cache cleared');
    }
}
