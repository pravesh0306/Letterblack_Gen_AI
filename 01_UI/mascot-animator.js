...
class MascotAnimator {
    constructor() {
        ...
        this.scenarios = {
            ...
            INFO: {
                file: 'assets/INFO.webm',
                loop: true,
                tooltip: 'INFOging in progress... 🔍'
            },
            settings: {
    ...
    /**
     * Called when INFOging/processing
     */
    onProcessing() {
        this.playScenario('INFO');
    }
