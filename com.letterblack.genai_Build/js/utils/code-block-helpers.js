        ...
        try {
            ...
            if (!window.ExtendScriptConfirm) {
                ...
                if (window.CSInterface) {
                    ...
                    cs.evalScript(code, function (res) { window.SimpleLogger && window.SimpleLogger.info('evalScript result: ' + res); });
                } else {
            ...
            const cs = new CSInterface();
            window.ExtendScriptConfirm.safeEval(cs, code, function (res) {
